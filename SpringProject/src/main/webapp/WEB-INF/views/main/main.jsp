...
<div class="content-wrap">
	...
	<div class="section nobottommargin" style="max-width: 1170px;margin: auto;background-color: #ffffff;">
			...
			<div class="container clearfix">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 bottommargin">
						...
						<div class="team">
							<div class="team-image">
								<img src="images/team/4.jpg" alt="John Doe">
							</div>
							<div class="team-desc team-desc-bg">
								<div class="team-title"><h4>김대표</h4><span>CEO</span></div>
					...
					<div class="col-lg-3 col-md-6 bottommargin">
						...
						<div class="team">
							<div class="team-image">
								<img src="images/team/3.jpg" alt="Nix Maxwell">
							</div>
							<div class="team-desc team-desc-bg">
								<div class="team-title"><h4>난의사</h4><span>진료의사</span></div>
								<a href="#" class="social-icon inline-block si-small si-light si-rounded si-facebook">
									<i class="icon-facebook"></i>
									<i class="icon-facebook"></i>
								</a>
