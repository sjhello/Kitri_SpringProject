...
<script>
	$(document).ready(function() {
		$('#qaWrite11Button').click(function() {
			$title = $('#title');
			$content = $('#content1');
		...
		<section id="content">
			<div class="content-wrap">
				<div class="container clearfix" style="margin-bottom: 175px;">
					<h4>1:1 문의</h4>
					<div class="col_one">
						<form id="qaWrite11Form" class="form-horizontal" action='qaWrite11.do' method="post">
						<table class="table table-bordered">
						  ...
						  <tbody>
							<tr>
							  <td>제목</td>
							  <td><input type="text" id="title" name="title" style="width:487px" maxlength="100"/></td>
							</tr>
							<tr>
							  <td>아이디</td>
							  <td>${id }</td>
							...
							<tr>
							  <td>내용</td>
							  <td style=" height: 386px; "><textarea id="content" name="content" rows="25" cols="61" style="resize: none;" maxlength="4000"></textarea></td>
							</tr>
							<tr>
								<td colspan="2">
									<a id="qaWrite11Button" href="#" class="btn btn-secondary btn-sm fright" style=" margin-left: 3px; ">작성</a>
