	    ...
	    <div class="col-12">
	        ...
	        <div class="widget has-shadow">
	            ...
	            <div class="widget-body">
                    ...
                    <a href="memberList.do"><button type="button" class="btn btn-success btn-square mr-1 mb-2">작성</button></a>
                    <a href="memberList.do"><button type="button" class="btn btn-secondary btn-square mr-1 mb-2">취소</button></a>
	            </div>
	            </form>
	        </div>
	        <!-- End Form -->
