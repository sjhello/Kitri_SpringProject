                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>10/21/2017</td>
                                <td class="td-actions">
                                    <a href="adQa-Write.do"><i class="la la-edit edit"></i></a>
                                    <a href="adQa-Delete.do"><i class="la la-close delete"></i></a>
                                </td>
                                <td>
                                	<a href="adQa-Update.do"><button type="button" class="btn btn-danger ripple mr-1 mb-2">수정</button></a>
                                </td>
                            </tr>
                            <tr>
                                <td><span class="text-primary">021-12-US</span></td>
