			...
			$.ajax({
				...
				success:function(data) {
					...
					$.each(data, function() {
						 html="";
						 html += "<tr>";
						 html += "<td><span class='text-primary'>"+this.q_num+"</span></td>";
						 html += "<td>"+this.title+"</td>";
					     html += "<td>"+this.reg_date+"</td>";
					     html += "<td class='td-actions'>";
					   	 html += "<a class='deleteFunction' href='javascript:void(0)' data-num='"+this.q_num+"''><i class='la la-close delete'></i></a>";
					   	 html += "</td>";
					   	 html += "<td>";
					   	 html += "<a href='qaUpdateForm.do?q_num="+this.q_num+"'><button type='button' class='btn btn-danger ripple mr-1 mb-2'>수정</button></a>";
					   	 html += "</td>";
					   	 html += "</tr>";
					     $("#qaBody").append(html);
					});
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody id="qaBody">
                            ...
                            <tr>
                                ...
                                <td class="td-actions">
                                    <a class="deleteFunction" href="javascript:void(0)" data-num="${qaList.q_num } "><i class="la la-close delete"></i></a>
                                </td>
                                <td>
